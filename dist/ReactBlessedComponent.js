  ...
  _createClass(ReactBlessedComponent, [{
    ...
    value: function mountNode(parent, element) {
      var props = element.props,
          ...
          blessedElement = (0, _lodash.startsWith)(type, 'contrib') ? _blessedContrib2.default[type.replace('contrib', '')] : _blessed2.default[type];

      (0, _invariant2.default)(!!blessedElement, 'Invalid blessed element "' + type + '".');

      var node = blessedElement((0, _solveClass2.default)(options));
